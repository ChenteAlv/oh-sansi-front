...
export const useNotifications = () => {
    ...
    const cargarNotificaciones = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.get('https://oh-sansi-back-production.up.railway.app/api/notificaciones', {
                headers: {
    ...
    const marcarComoLeida = async (id) => {
        try {
            const response = await axios.patch(
                `https://oh-sansi-back-production.up.railway.app/api/notificaciones/${id}/leida`,
    ...
    const eliminarNotificacion = async (id) => {
        try {
            const response = await axios.delete(
                `https://oh-sansi-back-production.up.railway.app/api/notificaciones/${id}`,
                {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('token')}`,
                        'Content-Type': 'application/json'
    ...
    const marcarTodasComoLeidas = async () => {
        try {
            const response = await axios.patch(
                'https://oh-sansi-back-production.up.railway.app/api/notificaciones/todas/leidas',
                {}, // Body vacío para PATCH
                {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('token')}`,
